<template>
    <div class="app-container">
        ...
        <div class="rep-bottom">
            <div class="title">{{stationInfo.time}}年度降雨量报表</div>
            <div class="subtitle">
                <div class="sub-left">
...
<script setup>
import {getStationList,getStpptnRYearOrMonthReport} from "@/api/informationManager/rainWaterReport";
...
const exportPptnYear = () =>{
    proxy.download("/business/realData/pptnR/pptnYearOrMonthReportExport", {
        stcd:formInline.stcd,
        time:formInline.time,
        stName:stationInfo.stname
  },`${stationInfo.stname}${stationInfo.time}年度降雨量年报_${new Date().getTime()}.xlsx`);
}
