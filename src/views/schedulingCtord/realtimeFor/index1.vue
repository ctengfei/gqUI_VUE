<template>
  <div class="app-container" style="display: flex;flex-direction: column">
    <div class="head ">
      <span class="head-title" style="margin-right: 50px">实时预报结果</span>
      <span style="font-weight: bold">预报区域：</span>
      ...
      <div v-show="select1 == 1">
        <span style="margin-left: 30px;font-weight: bold">断面选择：</span>
      ...
      <el-button style="margin-left: 100px" @click="handleSetStatus" type="primary">
        {{ `${status == 1 ? '启动' : '暂停'}滚动预报` }}
      </el-button>
    </div>
    <div class="card-container">
      <li v-show="select1 == 0" style="display: flex;flex-direction: column;align-items: flex-start;flex: 0.5">
    ...
    <div v-show="select1 == 1" class="real-boo-container">
