        ...
        <div class="top">
          ...
          <div class="box2">
            <li>
              ...
              <div class="bm_r">
                <span class="b_2">数量 <strong>{{ ditch.chanInfo.canalNum || 0 }}</strong> 条</span>
                <span class="b_2">渠长 <strong>{{ ditch.chanInfo.canalLength || 0 }}</strong> km</span>
              </div>
            </li>
            <li>
              <i class="gq"></i>
              ...
              <div class="bm_r">
                <span class="b_2">数量 <strong>{{ ditch.chanInfo.mainCanalNum || 0 }}</strong> 条</span>
                <span class="b_2">渠长 <strong>{{ ditch.chanInfo.mainCanalLength || 0 }}</strong> km</span>
              </div>
            </li>
            <li>
              <i class="zq"></i>
              ...
              <div class="bm_r">
                <span class="b_2">数量 <strong>{{ ditch.chanInfo.branchCanalNum || 0 }}</strong> 条</span>
                <span class="b_2">渠长 <strong>{{ ditch.chanInfo.branchCanalLength || 0 }}</strong> km</span>
              </div>
            </li>
          </div>
          <div class="box3">
            <li>
              ...
              <strong>{{ ditch.wagaInfo.checkGateNum || 0 }}<span> 个</span></strong>
            </li>
            <li>
              <i class="fsz"></i>
              <span class="b_1">分水闸</span>
              <strong>{{ ditch.wagaInfo.turnOutGateNum || 0 }}<span> 个</span></strong>
            </li>
            <li>
              <i class="xhz"></i>
              <span class="b_1">泄洪闸</span>
              <strong>{{ ditch.wagaInfo.floodGateNum || 0 }}<span> 个</span></strong>
            </li>
            <li>
              <i class="dm"></i>
              <span class="b_1">斗门</span>
              <strong>{{ ditch.wagaInfo.sluiceGateNum || 0 }}<span> 个</span></strong>
            </li>
            <li>
              <i class="hd"></i>
              <span class="b_1">涵洞</span>
              <strong>{{ ditch.culvNum || 0 }}<span> 个</span></strong>
            </li>
            <li>
              <i class="sd"></i>
              <span class="b_1">隧洞</span>
              <strong>{{ ditch.tunnelNum || 0 }}<span> 个</span></strong>
            </li>
          </div>
        </div>
        <div class="bottom">
          <li>
            <h3>实时数据<span>（{{ time1 }}）</span></h3>
...
<!--                <div class="are_txt">-->
<!--                  <span>王英水库</span>-->
<!--                  <span><strong>{{ realTime.wyRainfall || 0 }}</strong> mm</span>-->
<!--                </div>-->
<!--                <div class="are_txt">-->
<!--                  <span>蔡贤水库</span>-->
<!--                  <span><strong>{{ realTime.cxRainfall || 0 }}</strong> mm</span>-->
<!--                </div>-->
<!--                <div class="are_txt">-->
<!--                  <span>王英灌区</span>-->
<!--                  <span><strong>{{ realTime.gqRainfall || 0 }}</strong> mm</span>-->
<!--                </div>-->
<!--              </div>-->
            </div>
          ...
          <li>
            ...
            <div class="follow">
              <div class="tabs">
                ...
                <div :class="{'is-active':index==6,'tab':true}" @click="handleSelect(6,'ZZ')">渠道水文</div>
              ...
              <div class="tableBox" ref="tableRef">
                <el-table
                    ...
                    :data="tableData">
                  <el-table-column align="center" :width=columnWidth(index) sortable :prop="prop" label="点位名称">
                    <template #default="{row}">
                      <div style="display: flex; align-items: center">
                        <el-icon :style="{ color:row.isFollow ? '#FFD700' :'' }" @click="handleClick(row)" size="23"><StarFilled /></el-icon>
                        <span style="margin-left: 10px">{{ row.wmstName || row.stName.replace("雨量站","") }}</span>
                      </div>
                    </template>
                  </el-table-column>
                  <el-table-column align="center" label="1h(mm)" sortable width="100" prop="oneHourDrp" v-if="index == 1 || index == 8">
                  </el-table-column>
                  <el-table-column align="center" label="24h(mm)" sortable width="120" prop="oneDayDrp"  v-if="index == 1 || index == 8">
                  </el-table-column>
                  <el-table-column align="center" label="今日(mm)" sortable width="120"  prop="toDayDrp" v-if="index == 1 || index == 8">
                  </el-table-column>
                  <el-table-column align="center" label="本月(mm)" sortable width="120" prop="monthDrp" v-if="index == 1 || index == 8">
                  </el-table-column>
                  <el-table-column align="center" label="本年(mm)" sortable width="120" prop="yearDrp" v-if="index == 1 || index == 8">
                  </el-table-column>
<!--                  <el-table-column align="center" label="3h"  prop="threeHourDrp"  v-if="index == 1 || index == 8">-->
<!--                  </el-table-column>-->
<!--                  <el-table-column align="center" label="6h" prop="sixHourDrp" v-if="index == 1 || index == 8">-->
<!--                  </el-table-column>-->
<!--                  <el-table-column align="center" label="12h" prop="twelveHourDrp"  v-if="index == 1 || index == 8">-->
<!--                  </el-table-column>-->
                  <el-table-column align="center" v-if="index==2" prop="rz" label="库上水位(m)">
                    <template #default="{ row }">
                  ...
                  <el-table-column align="center" v-if="index==3" prop="upz" label="闸前水位(m)"></el-table-column>
                  ...
                  <el-table-column align="center" v-if="index==6  || index==5 " prop="z" label="水位(m)"></el-table-column>
                  <el-table-column align="center" v-if="index==6 || index==5 " prop="q" label="流量(m³/s)"></el-table-column>
                  <el-table-column align="center" v-if="index<=8 && index != 4" :formatter="formatCount" width="110" prop="tm" label="数据时间"></el-table-column>
                </el-table>
              </div>
            </div>
          </li>
        ...
        <div class="info">
          ...
          <div class="info-box">
            <li>
              ...
              <div class="tabs">
                <span>当前蓄水量：<strong>{{ (wy.w /100).toFixed(3) || 0 }}</strong>亿m³</span>
                <span>有效蓄水量：<strong>{{ ((wy.w - (wy.deadCap / 10000))/100).toFixed(3) || 0 }}</strong>亿m³</span>
              </div>
              <div class="chartQ">
                <div  class="charts">
                  <div class="line-a">
                  ...
                  <div ref="chart3" style="height: 100%"></div>
                </div>
                <div class="line-box">
                  <div class="total-box">
                    ...
                    <div class="total-tr">
                      <div>调洪库容</div>
                      <div><strong>{{ wy.storFlCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                    <div class="total-xl">
                      <div>兴利库容</div>
                      <div><strong>{{ wy.benResCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                    <div class="total-s">
                      <div>死库容</div>
                      <div><strong>{{ wy.deadCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li>
              ...
              <div class="tabs">
                <span>当前蓄水量：<strong>{{  (cx.w /100).toFixed(3) || 0 }}</strong>亿m³</span>
                <span>有效蓄水量：<strong>{{ ((cx.w - (cx.deadCap / 10000))/100).toFixed(3) || 0 }}</strong>亿m³</span>
              </div>
              <div class="chartQ">
                <div  class="charts">
                  <div class="line-a">
...
<!--                  </div>-->
                  ...
                  <div ref="chart4" style="height: 100%">
                  </div>
                </div>
                <div class="line-box">
                  <div class="total-box">
                    ...
                    <div class="total-tr">
                      <div>调洪库容</div>
                      <div><strong>{{ cx.storFlCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                    <div class="total-xl">
                      <div>兴利库容</div>
                      <div><strong>{{ cx.benResCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                    <div class="total-s">
                      <div>死库容</div>
                      <div><strong>{{ cx.deadCap / 10000 || 0 }}</strong>亿m³</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="statistics">
          <h3>实际用水统计 <strong style="font-size: 14px;margin-left: 10px">({{ ysSys.total }}万m³)</strong></h3>
          <div class="item-box">
            <div class="item">
              <div class="title">
            ...
            <div class="item">
              ...
              <div class="chart-box" >
                <ul class="statice_total">
                  <li>
                    <span>计划总供水量</span>
                    <strong>{{ statice_total.planTotal || 0 }} <i>万m³</i></strong>
                  </li>
                  <li>
                    <span>已供总水量</span>
                    <strong>{{ statice_total.realityTotal || 0 }} <i>万m³</i></strong>
                  </li>
                  <li>
                    <span>还需供水</span>
                    <strong>{{ statice_total.waterDemandTotal || 0 }} <i>万m³</i></strong>
                  </li>
                </ul>
...
import {
  ...
  getTopTotal,
  getRadarImage,
  getWaterStatistics, getActualWaterUseStatistics, getResRain, getWaterUseSupplyContrast
...
const getSiteList = () => {
  ...
  getSite({stType:type.value,sourceType:sourceType.value,stName:input.value}).then(res=>{
    if(res.success){
